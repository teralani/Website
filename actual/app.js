...
function control1(button) {
    ...
    var s = document.getElementsByClassName('slider__wrapper')[0];
    var o = (s.scrollWidth - s.clientWidth)/5;
        console.log(o)
    ...
    if(button.value == "slide1") {s.scroll(0, 0)}
    if(button.value  == "slide2") {s.scroll(o*1, 0)}
    if(button.value  == "slide3") {s.scroll(o*2, 0)}
    if(button.value  == "slide4") {s.scroll(o*3, 0)}
    if(button.value  == "slide5") {s.scroll(o*4, 0)}
    if(button.value  == "slide6") {s.scroll(o*5, 0)}
    }
}
